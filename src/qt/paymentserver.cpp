...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click 2chcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start 2chcoin: click-to-pay handler");
    else
...
{
    // clicking on 2chcoin: URLs creates FileOpen events on the Mac:
